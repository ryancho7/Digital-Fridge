...
function UserHome() {
	...
	return (
		<div className='p-4 space-y-6'>
			...
			{/* Recipes Section */}
			<div
				className='relative bg-black/90 rounded-lg text-white mt-8 shadow-md cursor-pointer overflow-hidden h-32'
			...
			>
				...
				{/* Right image fully stretched to corner */}
				<img
			...
			{/* Expiring Soon */}
			<div className='relative bg-black/90 text-white p-6 rounded-lg shadow-md'>
